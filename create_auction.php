      ...
      <form method="post" action="create_auction_result.php">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <small id="conditionHelp" class="form-text text-muted"><span class="text-danger">* Required.</span> Select item condition.</small>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="reservePrice" value="(auto: 20% of start price)" readonly>
            </div>

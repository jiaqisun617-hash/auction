...
/* (Uncomment this block to restrict access to sellers only)
    ...
    <div class="card">
      <div class="card-body">
        <!-- Note: This form does not do any dynamic / client-side /
             ...
             very low priority / only done after all database functions are
             complete. -->
            ...
            <div class="col-sm-10">
              <div class="input-group">
                ...
                <input type="text"
                       class="form-control"
                       id="reservePrice"
                       value="(auto: 20% of start price)"
                       readonly>
              </div>
              <small id="reservePriceHelp" class="form-text text-muted">
                This value is automatically set to <strong>20% of the starting price</strong>. No input required.
              </small>
            </div>
          </div>

          <div class="form-group row">
            <label for="endTime" class="col-sm-2 col-form-label text-right">End date</label>
            <div class="col-sm-10">
              ...
              <small id="endDateHelp" class="form-text text-muted">
                <span class="text-danger">* Required.</span>
                Date and time for the auction to end.
              </small>
            </div>
          </div>

          <!-- Front-end upload field for item images -->
          <div class="form-group row">
